<div class="card mb-3 border border-success">
    <div class="card-body p-4 pb-0 pt-3">
        ...
        <p>Username: <small class="ms-2"><?= $_SESSION['account_username'] ?></small></p>
        <p>Program: <small class="ms-2">BSCS</small></p>
        <p>AY: <small class="ms-2">4th Year BSCS</small></p>
        <p>Account Status:
...
<div class="card border border-success" style="height: 53.2vh;">
    ...
    <div class="card-body">
        ...
        <p><i class="bi bi-calendar pe-2 text-success"></i>My Schedule</p>
        <p><i class="bi bi-bar-chart pe-2 text-success"></i>My Grades</p>
